...
export default function WebhooksPage() {
  ...
  return (
    <div className="flex flex-col gap-8">
      {/* Register Section */}
      <div className="p-6 flex flex-col gap-4 border border-zinc-800/80 bg-zinc-900/40 backdrop-blur-md rounded-2xl shadow-xl z-10">
        ...
        <form onSubmit={handleSubmit} className="grid grid-cols-1 md:grid-cols-[1fr_1fr_120px_auto] gap-4 items-end">
          ...
          <button type="submit" disabled={isSubmitting} className="bg-zinc-50 hover:bg-zinc-200 text-zinc-950 px-5 py-2.5 rounded-xl font-bold cursor-pointer flex items-center justify-center gap-2 transition-all duration-200 active:scale-[0.98] disabled:opacity-50 disabled:cursor-not-allowed">
            <Plus size={16} />
